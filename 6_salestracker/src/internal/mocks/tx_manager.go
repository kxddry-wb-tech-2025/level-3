...
import (
	context "context"
	service "salestracker/src/internal/service"
...
func (_m *TxManager) Do(ctx context.Context, fn func(context.Context, service.Tx) error) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(context.Context, service.Tx) error) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
