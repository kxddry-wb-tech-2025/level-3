...
let revenueChart, categoryChart, priceChart;

function renderAnalyticsCharts(items) {
    ...
    const dates = sortedItems.map(i => new Date(i.date).toLocaleDateString());
    const prices = sortedItems.map(i => i.price);
